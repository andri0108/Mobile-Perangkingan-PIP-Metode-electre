...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$handle = $pdo->prepare('INSERT INTO alternatif (kode_alternatif,id_KIP, nama_alternatif,asal_sekolah,username,password, tanggal_input) VALUES (:kode_alternatif, :id_KIP, :nama_alternatif,:asal_sekolah,:username,:password, :tanggal_input)');
			...
			<?php endif; ?>			
				...
				<form action="tambah-alternatif.php" method="post">
					...
					<div class="field-wrap clearfix">					
						...
						<input type="text" name="asal_sekolah" cols="30" value="<?php echo $asal_sekolah; ?>"</textarea>
					</div>
					<div class="field-wrap clearfix">					
						<label>Username</label>
						<input type="text" name="username" cols="30" value="<?php echo $username; ?>"</textarea>
					</div>
					<div class="field-wrap clearfix">					
						<label>Password</label>
						<input type="password" name="password" cols="30" value="<?php echo $password; ?>"</textarea>
					</div>
