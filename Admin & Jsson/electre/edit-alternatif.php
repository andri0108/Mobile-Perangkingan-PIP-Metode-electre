...
if(!$id_alternatif) {
	...
	$id_KIP = (isset($result['id_KIP'])) ? trim($result['id_KIP']) : '';
	$nama_alternatif = (isset($result['nama_alternatif'])) ? trim($result['nama_alternatif']) : '';
	$asal_sekolah = (isset($result['asal_sekolah'])) ? trim($result['asal_sekolah']) : '';
...
if(isset($_POST['submit'])):	
	...
	$id_KIP = (isset($_POST['id_KIP'])) ? trim($_POST['id_KIP']) : '';
	$nama_alternatif = (isset($_POST['nama_alternatif'])) ? trim($_POST['nama_alternatif']) : '';
	$asal_sekolah = (isset($_POST['asal_sekolah'])) ? trim($_POST['asal_sekolah']) : '';
	...
	if(empty($errors)):
		...
		$prepare_query = 'UPDATE alternatif SET kode_alternatif = :kode_alternatif,id_KIP = :id_KIP, nama_alternatif = :nama_alternatif, asal_sekolah = :asal_sekolah,tanggal_input = :tanggal_input WHERE id_alternatif = :id_alternatif';
		$data = array(
...
<?php
$judul_page = 'Edit Calon Penerima Beasiswa';
...
?>
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			<h1>Edit Calon Penerima Beasiswa</h1>
			...
			<?php else: ?>				
				...
				<form action="edit-alternatif.php?id=<?php echo $id_alternatif; ?>" method="post">
					<div class="field-wrap clearfix">					
						<label>NISN <span class="red">*</span></label>
						<input type="text" name="kode_alternatif" value="<?php echo $kode_alternatif; ?>">
					</div>
						<div class="field-wrap clearfix">					
						<label>KIP <span class="red">*</span></label>
						<input type="text" name="id_KIP" value="<?php echo $id_KIP; ?>">
					</div>					
					<div class="field-wrap clearfix">					
					...
					<div class="field-wrap clearfix">					
						...
						<textarea name="asal_sekolah" cols="30" rows="2"><?php echo $asal_sekolah; ?></textarea>
					</div>
					<div class="field-wrap clearfix">					
